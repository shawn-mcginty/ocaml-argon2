...
(* OASIS_START *)
(* DO NOT EDIT (digest: 827eaabdcaf43e42a03c80f8c4326c09) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Louis Roch\195\169 <louis@louisroche.net>"];
          homepage = None;
          synopsis =
            "OCaml bindings for Argon2 (https://github.com/P-H-C/phc-winner-argon2)";
          description = None;
          categories = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                           ...
                           post_command =
                             [
                                (OASISExpr.EBool true,
                                  Some
                                    (("cp",
                                       ["doc/style.css"; "argon2_api.docdir/"
                                       ])))
                             ]
                        };
                      doc_build =
                      ...
                      doc_title = "API reference for Argon2";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Khady/ocaml-argon2.git";
                      src_repo_browser =
                        Some "https://github.com/Khady/ocaml-argon2";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\180\235\232\235\148\1305_\208\225n[v\160\210\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
